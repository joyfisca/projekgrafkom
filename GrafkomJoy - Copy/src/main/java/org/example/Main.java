...
//        objects.get(0).getChildObject().get(8).rotateObject(300f, 0.0f, 1f, 0.0f);
        ...
        //Translasi dan Scaling Objek
        {
            ...
            objects.get(1).translateObject(0.6f, 0.25f, 2.3f);

            //Bomb 2
            objects.get(6).scaleObject(2f, 2f, 2f);
            objects.get(6).translateObject(-0.6f, 0.25f, 2.3f);
    ...
    public void input() {
        ...
        //WASD
        {
            if (window.isKeyPressed(GLFW_KEY_W)) {
                camera.addRotation((float) Math.toRadians(0.2), (float) Math.toRadians(0));
            }
            ...
            if (window.isKeyPressed(GLFW_KEY_A)) {
                camera.addRotation((float) Math.toRadians(0), (float) Math.toRadians(0.2));
            }
